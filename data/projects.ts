...
import {
  SiReact, SiNodedotjs, SiPostgresql, SiPrisma, SiTailwindcss, SiTypescript, SiRedis,
  SiJavascript, SiExpress, SiGooglecloud, SiSupabase, SiFastapi
} from 'react-icons/si';
  ...
  en: [
    {
      ...
      description:
        'Enterprise-grade SaaS platform for CV evaluation using a hybrid architecture (rule engine + Generative AI).',
      featured: true,
      problem:
        'Manual CV screening is subjective, slow, and struggles to deeply analyze technical competencies at scale.',
      solution:
        'A hybrid analysis solution combining strict rule-based extraction with Generative AI to evaluate, rank, and provide real-time feedback.',
      impact:
        'Detailed technical feedback generated in under 10 seconds, reducing screening time by 90% with a monetizable SaaS model.',
      bullets: [
  ...
  fr: [
    {
      ...
      title: 'AI CV Analyzer SaaS',
      description:
        "Plateforme SaaS d'évaluation de CV basée sur une architecture hybride (moteur de règles + IA générative).",
      featured: true,
      problem:
        'Le tri manuel des CV est subjectif, chronophage et inefficace pour évaluer la profondeur technique à grande échelle.',
      solution:
        "Une solution d'analyse hybride combinant extraction par règles et IA générative pour évaluer, classer et fournir un feedback en temps réel.",
      impact:
        "Feedback technique détaillé généré en moins de 10 secondes, réduisant de 90% le temps de pré-sélection avec un système SaaS monétisable.",
      bullets: [
