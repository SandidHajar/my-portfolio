export default {
  ...
  "hero": {
    ...
    "description": "Specializing in building scalable SaaS applications with a focus on high performance, clean architecture, and enterprise-grade security.",
    "bullets": [
      "5+ full-stack projects built from architectural design to production",
      "Expertise in REST APIs, JWT Auth, and Real-time Systems (SSE/WebSockets)",
      "Dedicated to writing clean, maintainable, and scalable codebases"
    ],
